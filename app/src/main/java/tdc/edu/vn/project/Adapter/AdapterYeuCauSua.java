...
public class AdapterYeuCauSua extends ArrayAdapter<NguoiBan> {
    ...
    public AdapterYeuCauSua(@NonNull Activity context, int resource, @NonNull ArrayList<NguoiBan> objects) {
    ...
    */
    ...
    private void dialognguoimua(final NguoiBan item){
        ...
        XacNhan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PetShopFireBase.pushItem(item, PetShopFireBase.TABLE_NGUOI_BAN);
                dialog.cancel();
            }
        });
